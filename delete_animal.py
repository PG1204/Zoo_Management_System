...
class add_book:
    def __init__(self,root):
        self.f=Frame(root.title("Delete Animal"),height=500,width=800,bg='dodgerblue3')

        self.f.propagate(0)

        self.f.pack()
        
        self.n=Label(text='DELETE ANIMAL',fg="black",bg="dodgerblue3",font=('Calibri Bold',26))
    ...
    def buttonclick(self,num):
        ...
        if(num==0):
            print(1)
            sql_delete_animal = "delete FROM animal WHERE animalID=%s AND speciesID=%s"
            print(2)
